                                    ...
                                    <div class="col l-6">
                                        <div class="main__wrapper-box-component">
                                            ...
                                            <input id="input-fullname" type="text"
                                                class="main__wrapper-box-component-input">
                                        </div>
                        ...
                        <div class="main__wrapper-box mt-40">
                            ...
                            <div class="main__wrapper-box-info">
                                <div class="row sm-gutter">
                                    ...
                                    <div class="col l-4">
                                        <div class="main__wrapper-box-component mt-20">
                                            <label for="select-cities"
                                                class="main__wrapper-box-component-label">Tỉnh/Thành phố</label>
                                            <select name="" id="select-cities"
                                                class="main__wrapper-box-component-input">
                                                <option value="1" class="main__wrapper-box-component-option">Tp.HCM
                                                </option>
                                            </select>
                                        </div>
                                        <span class="main__wrapper-box-component-error"></span>
                                    ...
                                    <div class="col l-4">
                                        <div class="main__wrapper-box-component mt-20">
                                            <label for="select-districts"
                                                class="main__wrapper-box-component-label">Quận/Huyện</label>
                                            <select name="" id="select-districts"
                                                class="main__wrapper-box-component-input">
                                                <option value="1" class="main__wrapper-box-component-option">Quận Gò Vấp
                                                </option>
                                            </select>
                                        </div>
                                        <span class="main__wrapper-box-component-error"></span>
                                    ...
                                    <div class="col l-4">
                                        <div class="main__wrapper-box-component mt-20">
                                            <label for="select-wards"
                                                class="main__wrapper-box-component-label">Phường/Xã</label>
                                            <select name="" id="select-wards" class="main__wrapper-box-component-input">
                                                <option value="1" class="main__wrapper-box-component-option">Phường 15
                                                </option>
                                            </select>
                                        </div>
                                        <span class="main__wrapper-box-component-error"></span>
                                    ...
                                    <div class="col l-6">
                                        <div class="main__wrapper-box-component mt-20 pd-10 paypal">
                                            ...
                                            <label for="input-shopeepay"
                                                ...
                                                <div class="main__wrapper-box-component-avatar">
                                                    <img src="https://mcdn.coolmate.me/image/September2021/195dbf69c0ac36f26fbd_(1).png"
                                                        alt="" class="main__wrapper-box-component-img">
                                                </div>
                                                <div class="main__wrapper-box-component-text">
                                                    <h3 class="main__wrapper-box-component-title">Ví điện tử ShopeePay
                                                    </h3>
                                                </div>
                                            </label>
                    ...
                    <div class="main__wrapper">
                        ...
                        <div class="main__order">
                            ...
                            <div class="main__order-sales">
                                ...
                                <div class="main__order-discount-price">-<span
                                        class="main__order-discount-number">0đ</span></div>
                            </div>
